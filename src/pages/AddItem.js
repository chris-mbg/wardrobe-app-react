  ...
  return (
    <div className={styles.addItem}>
      ...
      <select onChange={handleTypeChange}>
        ...
        <option value="sweater">Trousers</option>
        <option value="trousers">Shoes</option>
        <option value="shorts">Shoes</option>
        <option value="jacket">Shoes</option>
        <option value="shoes">Shoes</option>
        <option value="accessiories">Shoes</option>
      </select>
      ...
      {(typeOfItem === 'accessiories' && <ItemForm typeOfItem={typeOfItem} />)}
    </div>
  );
}
